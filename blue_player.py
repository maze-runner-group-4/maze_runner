...
for x in range(animation_steps):
 animation_list_left.append(sprite_sheet_left.get_image(x, 32, 50, 1, BLACK))

for x in range(animation_steps):
 animation_list_right.append(sprite_sheet_right.get_image(x, 32, 50, 1, BLACK))

for x in range(animation_steps):
 animation_list_up.append(sprite_sheet_up.get_image(x, 32, 50, 1, BLACK))
