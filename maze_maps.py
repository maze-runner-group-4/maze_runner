class Maze_maps:
    ...
    "X XX                 XX           XX   X",
    "X XX           T     XXT         TXX   X",
    "X XX       XXXXXXXX  XXXXXXXXLXXXXXX   X",
    ...
    "XXXXXXXXT    X               X  X  X   X",
    "XT           X  X  T          XXXXXXXXXX",
    "X  XXXX  T  XXXXXXXXXXX  T     X  X  X X",
    "X  X       T  X  X  X     G          T X",
    ...
    " XXXXXXXXX  SXXXX  X  XXXMX  XXXX   X ",
    " X H                                X ", 
